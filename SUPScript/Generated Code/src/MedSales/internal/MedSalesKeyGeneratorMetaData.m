...
@implementation MedSalesKeyGeneratorMetaData

+ (MedSalesKeyGeneratorMetaData*)getInstance
{
    return [[[MedSalesKeyGeneratorMetaData alloc] init] autorelease];
}

- (id)init
{
    if (self = [super init]) {
		self.id = _ENTITY_NUMBER_FOR_MedSalesKeyGenerator_;
		self.name = @"KeyGenerator";
		self.klass = [MedSalesKeyGenerator class];
		...
		self.table = @"medsales_1_0_keygenerator";
