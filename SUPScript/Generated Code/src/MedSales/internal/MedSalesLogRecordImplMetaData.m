#import "MedSalesLogRecordImplMetaData.h"
...
@implementation MedSalesLogRecordImplMetaData

+ (MedSalesLogRecordImplMetaData*)getInstance
{
    return [[[MedSalesLogRecordImplMetaData alloc] init] autorelease];
}

- (id)init
{
    if (self = [super init]) {
		self.id = _ENTITY_NUMBER_FOR_MedSalesLogRecordImpl_;
		self.name = @"LogRecordImpl";
		self.klass = [MedSalesLogRecordImpl class];
		...
		self.table = @"medsales_1_0_logrecordimpl";
