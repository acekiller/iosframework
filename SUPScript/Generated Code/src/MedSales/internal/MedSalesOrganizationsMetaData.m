...
@implementation MedSalesOrganizationsMetaData

+ (MedSalesOrganizationsMetaData*)getInstance
{
    return [[[MedSalesOrganizationsMetaData alloc] init] autorelease];
}

- (id)init
{
    if (self = [super init]) {
		self.id = _ENTITY_NUMBER_FOR_MedSalesOrganizations_;
		self.name = @"Organizations";
		self.klass = [MedSalesOrganizations class];
 		self.allowPending = YES;;

		self.isClientOnly = NO;

		SUPObjectList *attributes = [SUPObjectList getInstance];
		SUPAttributeMetaDataRBS* a_organization_id = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			331:
			[SUPDataType forName:@"int"]:@"integer":@"organization_id":@"":@"a":
			@"":-1:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_organization_id setColumn:@"a"];
		SUPAttributeMetaDataRBS* a_organization_name = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			332:
			[SUPDataType forName:@"string"]:@"varchar(1200)":@"organization_name":@"":@"b":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_organization_name setColumn:@"b"];
		SUPAttributeMetaDataRBS* a_organization_region = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			333:
			[SUPDataType forName:@"string"]:@"varchar(1200)":@"organization_region":@"":@"c":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_organization_region setColumn:@"c"];
		SUPAttributeMetaDataRBS* a_organization_street = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			334:
			[SUPDataType forName:@"string"]:@"varchar(1200)":@"organization_street":@"":@"d":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_organization_street setColumn:@"d"];
		SUPAttributeMetaDataRBS* a_organization_city = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			335:
			[SUPDataType forName:@"string"]:@"varchar(1200)":@"organization_city":@"":@"e":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_organization_city setColumn:@"e"];
		SUPAttributeMetaDataRBS* a_organization_state = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			336:
			[SUPDataType forName:@"string"]:@"varchar(1200)":@"organization_state":@"":@"f":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_organization_state setColumn:@"f"];
		SUPAttributeMetaDataRBS* a_organization_zip = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			337:
			[SUPDataType forName:@"int"]:@"integer":@"organization_zip":@"":@"g":
			@"":-1:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_organization_zip setColumn:@"g"];
		SUPAttributeMetaDataRBS* a_organization_phone = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			338:
			[SUPDataType forName:@"string"]:@"varchar(1200)":@"organization_phone":@"":@"h":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_organization_phone setColumn:@"h"];
		...
		[attributes addThis:a_organization_id];
		[attributes addThis:a_organization_name];
		[attributes addThis:a_organization_region];
		[attributes addThis:a_organization_street];
		[attributes addThis:a_organization_city];
		[attributes addThis:a_organization_state];
		[attributes addThis:a_organization_zip];
		[attributes addThis:a_organization_phone];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"Organizations*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"Organizations"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_organization_id = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"organization_id":[SUPDataType forName:@"int"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_organization_id];
		...
		[o_findByPrimaryKey_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByRegion_1 = [SUPOperationMetaData createOperationMetaData:3:(SUPString)@"findByRegion":[SUPDataType forName:@"Organizations*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByRegion_region = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"region":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByRegion_region];
			o_findByRegion_1.parameters = parameters_list;
	 	}
		[o_findByRegion_1 setIsStatic:YES];
		[o_findByRegion_1 setIsCreate:NO];
		[o_findByRegion_1 setIsUpdate:NO];
		[o_findByRegion_1 setIsDelete:NO]; 		
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:11:(SUPString)@"findWithQuery":[SUPDataType forName:@"Organizations*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_getSize_1 setIsDelete:NO]; 		
 		...
 		[operations addThis:o_findByRegion_1];
		...
		self.table = @"medsales_1_0_organizations";
		...
		[i_findByPrimaryKeyIndex.attributes add:a_organization_id];
