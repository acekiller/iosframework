...
@implementation MedSalesPackagePropertiesMetaData

+ (MedSalesPackagePropertiesMetaData*)getInstance
{
    return [[[MedSalesPackagePropertiesMetaData alloc] init] autorelease];
}

- (id)init
{
    if (self = [super init]) {
		self.id = _ENTITY_NUMBER_FOR_MedSalesPackageProperties_;
		self.name = @"PackageProperties";
		self.klass = [MedSalesPackageProperties class];
		...
		self.table = @"medsales_1_0_packageproperties";
