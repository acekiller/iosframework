...
@implementation MedSalesSISSubscriptionMetaData

+ (MedSalesSISSubscriptionMetaData*)getInstance
{
    return [[[MedSalesSISSubscriptionMetaData alloc] init] autorelease];
}

- (id)init
{
    if (self = [super init]) {
		self.id = _ENTITY_NUMBER_FOR_MedSalesSISSubscription_;
		self.name = @"SISSubscription";
		self.klass = [MedSalesSISSubscription class];
