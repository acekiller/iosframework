...
@interface MedSalesChangeLogKey : SUPAbstractStructure<SUPClassWithMetaData>
{
@private
    int32_t _entityType;
...
@end
typedef SUPObjectList MedSalesChangeLogKeyList;

// internal methods declaration, only used by generated code.
@interface MedSalesChangeLogKey(internal)
