...
/*!
 @class MedSalesPackageProperties
...
@interface MedSalesPackageProperties : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData, SUPAbstractPackageProperties>
{
@private
    NSString* _value;
    NSString* _key;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (MedSalesPackageProperties*)load:(NSString*)id;
/*!
  @method 
...
@end
typedef SUPObjectList MedSalesPackagePropertiesList;

// internal methods declaration, only used by generated code.
@interface MedSalesPackageProperties(internal)
