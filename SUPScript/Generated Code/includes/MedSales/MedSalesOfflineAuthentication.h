...
/*!
 @class MedSalesOfflineAuthentication
...
@interface MedSalesOfflineAuthentication : SUPAbstractLocalEntity<SUPLocalBusinessObject, SUPClassWithMetaData>
{
@private
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (MedSalesOfflineAuthentication*)load:(NSString*)id;
/*!
  @method 
...
@end
typedef SUPObjectList MedSalesOfflineAuthenticationList;

// internal methods declaration, only used by generated code.
@interface MedSalesOfflineAuthentication(internal)
