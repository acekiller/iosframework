...
@interface MedSalesSurgeons : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    int32_t _surgeon_id;
    NSString* _surgeon_name;
    NSString* _surgeon_specialization;
    NSString* _surgeon_organization;
    int64_t _surrogateKey;
}

@property(assign,nonatomic) int32_t surgeon_id;
@property(retain,nonatomic) NSString* surgeon_name;
@property(retain,nonatomic) NSString* surgeon_specialization;
@property(retain,nonatomic) NSString* surgeon_organization;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (MedSalesSurgeons*)load:(int64_t)id;
/*!
  @method 
...
@end
typedef SUPObjectList MedSalesSurgeonsList;

// internal methods declaration, only used by generated code.
@interface MedSalesSurgeons(internal)
