...
@interface MedSalesChangeLogImpl : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData,SUPChangeLog>
{
@private
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (MedSalesChangeLogImpl*)load:(MedSalesChangeLogKey*)id;
/*!
  @method 
...
@end
typedef SUPObjectList MedSalesChangeLogImplList;

// internal methods declaration, only used by generated code.
@interface MedSalesChangeLogImpl(internal)
