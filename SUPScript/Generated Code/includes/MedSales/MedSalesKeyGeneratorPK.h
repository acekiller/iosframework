...
@interface MedSalesKeyGeneratorPK : SUPAbstractStructure<SUPClassWithMetaData>
{
@private
    NSString* _remoteId;
    int64_t _batchId;
...
@end
typedef SUPObjectList MedSalesKeyGeneratorPKList;

// internal methods declaration, only used by generated code.
@interface MedSalesKeyGeneratorPK(internal)
