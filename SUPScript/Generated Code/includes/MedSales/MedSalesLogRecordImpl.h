...
@interface MedSalesLogRecordImpl : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData,SUPLogRecord>
{
@private
    int32_t _level;
    int32_t _code;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (MedSalesLogRecordImpl*)load:(int64_t)id;
/*!
  @method 
...
@end
typedef SUPObjectList MedSalesLogRecordImplList;

// internal methods declaration, only used by generated code.
@interface MedSalesLogRecordImpl(internal)
