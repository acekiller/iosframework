...
@interface MedSalesAccounts : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    int32_t _account_id;
    NSString* _account_username;
    NSString* _account_password;
    int64_t _surrogateKey;
}

@property(assign,nonatomic) int32_t account_id;
@property(retain,nonatomic) NSString* account_username;
@property(retain,nonatomic) NSString* account_password;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (MedSalesAccounts*)load:(int64_t)id;
/*!
  @method 
...
@end
typedef SUPObjectList MedSalesAccountsList;

// internal methods declaration, only used by generated code.
@interface MedSalesAccounts(internal)
