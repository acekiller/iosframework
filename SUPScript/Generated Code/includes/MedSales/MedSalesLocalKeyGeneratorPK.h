...
@interface MedSalesLocalKeyGeneratorPK : SUPAbstractStructure<SUPClassWithMetaData>
{
@private
    NSString* _remoteId;
    int64_t _batchId;
...
@end
typedef SUPObjectList MedSalesLocalKeyGeneratorPKList;

// internal methods declaration, only used by generated code.
@interface MedSalesLocalKeyGeneratorPK(internal)
