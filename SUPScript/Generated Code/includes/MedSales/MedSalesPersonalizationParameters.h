...
@interface MedSalesPersonalizationParameters : SUPAbstractPersonalizationParameters<SUPClassWithMetaData>
{
@private
    NSString* _username;
...
@end
typedef SUPObjectList MedSalesPersonalizationParametersList;

// internal methods declaration, only used by generated code.
@interface MedSalesPersonalizationParameters(internal)
