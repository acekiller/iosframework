...
@implementation MedSalesSurgeonsMetaData

+ (MedSalesSurgeonsMetaData*)getInstance
{
    return [[[MedSalesSurgeonsMetaData alloc] init] autorelease];
}

- (id)init
{
    if (self = [super init]) {
		self.id = _ENTITY_NUMBER_FOR_MedSalesSurgeons_;
		self.name = @"Surgeons";
		self.klass = [MedSalesSurgeons class];
 		self.allowPending = YES;;

		self.isClientOnly = NO;

		SUPObjectList *attributes = [SUPObjectList getInstance];
		SUPAttributeMetaDataRBS* a_surgeon_id = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			340:
			[SUPDataType forName:@"int"]:@"integer":@"surgeon_id":@"":@"a":
			@"":-1:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_surgeon_id setColumn:@"a"];
		SUPAttributeMetaDataRBS* a_surgeon_name = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			341:
			[SUPDataType forName:@"string"]:@"varchar(1200)":@"surgeon_name":@"":@"b":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_surgeon_name setColumn:@"b"];
		SUPAttributeMetaDataRBS* a_surgeon_specialization = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			342:
			[SUPDataType forName:@"string"]:@"varchar(1200)":@"surgeon_specialization":@"":@"c":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_surgeon_specialization setColumn:@"c"];
		SUPAttributeMetaDataRBS* a_surgeon_organization = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			343:
			[SUPDataType forName:@"string"]:@"varchar(1200)":@"surgeon_organization":@"":@"d":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_surgeon_organization setColumn:@"d"];
		...
		[attributes addThis:a_surgeon_id];
		[attributes addThis:a_surgeon_name];
		[attributes addThis:a_surgeon_specialization];
		[attributes addThis:a_surgeon_organization];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"Surgeons*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"Surgeons"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_surgeon_id = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"surgeon_id":[SUPDataType forName:@"int"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_surgeon_id];
		...
		[o_findByPrimaryKey_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByOrganization_1 = [SUPOperationMetaData createOperationMetaData:3:(SUPString)@"findByOrganization":[SUPDataType forName:@"Surgeons*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByOrganization_organization = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"organization":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByOrganization_organization];
			o_findByOrganization_1.parameters = parameters_list;
	 	}
		[o_findByOrganization_1 setIsStatic:YES];
		[o_findByOrganization_1 setIsCreate:NO];
		[o_findByOrganization_1 setIsUpdate:NO];
		[o_findByOrganization_1 setIsDelete:NO]; 		
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:11:(SUPString)@"findWithQuery":[SUPDataType forName:@"Surgeons*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_getSize_1 setIsDelete:NO]; 		
 		...
 		[operations addThis:o_findByOrganization_1];
		...
		self.table = @"medsales_1_0_surgeons";
		...
		[i_findByPrimaryKeyIndex.attributes add:a_surgeon_id];
