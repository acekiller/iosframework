...
@implementation MedSalesKeyGeneratorPKMetaData

+ (MedSalesKeyGeneratorPKMetaData*)getInstance
{
    return [[[MedSalesKeyGeneratorPKMetaData alloc] init] autorelease];
}
...
- (id)init
{
	if (self = [super init]) {
		...
		self.klass = [MedSalesKeyGeneratorPK class];
