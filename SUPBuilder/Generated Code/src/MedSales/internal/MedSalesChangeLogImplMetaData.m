#import "MedSalesChangeLogImplMetaData.h"
...
@implementation MedSalesChangeLogImplMetaData

+ (MedSalesChangeLogImplMetaData*)getInstance
{
    return [[[MedSalesChangeLogImplMetaData alloc] init] autorelease];
}

- (id)init
{
    if (self = [super init]) {
		self.id = _ENTITY_NUMBER_FOR_MedSalesChangeLogImpl_;
		self.name = @"ChangeLogImpl";
		self.klass = [MedSalesChangeLogImpl class];
		...
		self.table = @"medsales_1_0_changelogimpl";
