...
@implementation MedSalesLocalKeyGeneratorMetaData

+ (MedSalesLocalKeyGeneratorMetaData*)getInstance
{
    return [[[MedSalesLocalKeyGeneratorMetaData alloc] init] autorelease];
}

- (id)init
{
    if (self = [super init]) {
		self.id = _ENTITY_NUMBER_FOR_MedSalesLocalKeyGenerator_;
		self.name = @"LocalKeyGenerator";
		self.klass = [MedSalesLocalKeyGenerator class];
		...
		self.table = @"co_medsales_1_0_localkeygenerator";
